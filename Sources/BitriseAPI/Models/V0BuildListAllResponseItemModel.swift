...
public struct V0BuildListAllResponseItemModel: Codable {
    ...
    public init(abortReason: String?, branch: String?, buildNumber: Int?, commitHash: String?, commitMessage: String?, commitViewUrl: String?, environmentPrepareFinishedAt: String?, finishedAt: String?, isOnHold: Bool?, machineTypeId: String?, originalBuildParams: String?, pullRequestId: Int?, pullRequestTargetBranch: String?, pullRequestViewUrl: String?, repository: V0AppResponseItemModel?, slug: String?, stackIdentifier: String?, startedOnWorkerAt: String?, status: Int?, statusText: String?, tag: String?, triggeredAt: String?, triggeredBy: String?, triggeredWorkflow: String?) {
