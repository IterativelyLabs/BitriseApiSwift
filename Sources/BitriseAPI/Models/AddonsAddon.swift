...
public struct AddonsAddon: Codable {
    ...
    public init(bannerImage: String?, cardHeaderColors: [String]?, categories: [String]?, _description: String?, developerLinks: [AddonsDeveloperLink]?, documentationUrl: String?, hasUi: Bool?, icon: String?, _id: String?, isBeta: Bool?, plans: [AddonsPlan]?, platforms: [String]?, previewImages: [String]?, setupGuide: AddonsSetupGuide?, subtitle: String?, summary: String?, title: String?) {
