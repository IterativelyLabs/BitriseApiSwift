...
open class OrganizationsAPI {
  ...
  "data" : [ {
    ...
    open class func orgListWithRequestBuilder() -> RequestBuilder<V0OrganizationListRespModel> {
        ...
        let requestBuilder: RequestBuilder<V0OrganizationListRespModel>.Type = BitriseAPIAPI.requestBuilderFactory.getBuilder()
  ...
  "data" : {
    ...
    open class func orgShowWithRequestBuilder(orgSlug: String) -> RequestBuilder<V0OrganizationRespModel> {
        ...
        let requestBuilder: RequestBuilder<V0OrganizationRespModel>.Type = BitriseAPIAPI.requestBuilderFactory.getBuilder()
