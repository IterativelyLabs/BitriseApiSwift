...
open class BuildArtifactAPI {
  ...
  "data" : {
    ...
    open class func artifactDeleteWithRequestBuilder(appSlug: String, buildSlug: String, artifactSlug: String) -> RequestBuilder<V0ArtifactDeleteResponseModel> {
        ...
        let requestBuilder: RequestBuilder<V0ArtifactDeleteResponseModel>.Type = BitriseAPIAPI.requestBuilderFactory.getBuilder()
  ...
  "paging" : {
    ...
    open class func artifactListWithRequestBuilder(appSlug: String, buildSlug: String, next: String? = nil, limit: Int? = nil) -> RequestBuilder<V0ArtifactListResponseModel> {
        ...
        let requestBuilder: RequestBuilder<V0ArtifactListResponseModel>.Type = BitriseAPIAPI.requestBuilderFactory.getBuilder()
    ...
    open class func artifactShow(appSlug: String, buildSlug: String, artifactSlug: String, completion: @escaping ((_ data: V0ArtifactShowResponseModel?,_ error: Error?) -> Void)) {
        artifactShowWithRequestBuilder(appSlug: appSlug, buildSlug: buildSlug, artifactSlug: artifactSlug).execute { (response, error) -> Void in
            completion(response?.body, error)
        }
    }
  ...
  "data" : {
    ...
    open class func artifactShowWithRequestBuilder(appSlug: String, buildSlug: String, artifactSlug: String) -> RequestBuilder<V0ArtifactShowResponseModel> {
        ...
        let requestBuilder: RequestBuilder<V0ArtifactShowResponseModel>.Type = BitriseAPIAPI.requestBuilderFactory.getBuilder()
